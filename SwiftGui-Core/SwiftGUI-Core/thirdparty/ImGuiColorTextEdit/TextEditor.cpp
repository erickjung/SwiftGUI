...
void TextEditor::HandleKeyboardInputs()
{
	...
	if (ImGui::IsWindowFocused())
	{
        ...
        if (!IsReadOnly() && ctrl && !shift && !alt && ImGui::IsKeyPressed(ImGui::GetKeyIndex(ImGuiKey_Z))) {
            ...
            MoveUp(1, shift); return;
        }
        else if (!ctrl && !alt && ImGui::IsKeyPressed(ImGui::GetKeyIndex(ImGuiKey_DownArrow))) {
            MoveDown(1, shift); return;
        }
        else if (!alt && ImGui::IsKeyPressed(ImGui::GetKeyIndex(ImGuiKey_LeftArrow))) {
            MoveLeft(1, shift, ctrl); return;
        }
        else if (!alt && ImGui::IsKeyPressed(ImGui::GetKeyIndex(ImGuiKey_RightArrow))) {
            MoveRight(1, shift, ctrl); return;
        }
        else if (!alt && ImGui::IsKeyPressed(ImGui::GetKeyIndex(ImGuiKey_PageUp))) {
            MoveUp(GetPageSize() - 4, shift); return;
        }
        else if (!alt && ImGui::IsKeyPressed(ImGui::GetKeyIndex(ImGuiKey_PageDown))) {
            MoveDown(GetPageSize() - 4, shift); return;
        }
        else if (!alt && ctrl && ImGui::IsKeyPressed(ImGui::GetKeyIndex(ImGuiKey_Home))) {
            MoveTop(shift); return;
        }
        else if (ctrl && !alt && ImGui::IsKeyPressed(ImGui::GetKeyIndex(ImGuiKey_End))) {
            MoveBottom(shift); return;
        }
        else if (!ctrl && !alt && ImGui::IsKeyPressed(ImGui::GetKeyIndex(ImGuiKey_Home))) {
            MoveHome(shift); return;
        }
        else if (!ctrl && !alt && ImGui::IsKeyPressed(ImGui::GetKeyIndex(ImGuiKey_End))) {
            MoveEnd(shift); return;
        }
...
void TextEditor::InsertErrorMarker(ErrorMarkers& aMarkers, int index, const std::string& text) {
    
//    aMarkers.insert(std::make_pair(index, std::string(text)));
    aMarkers.insert(std::make_pair(index, text));
}
...
void TextEditor::Delete()
{
    ...
    if (mLines.size() == 1 && mLines.at(0).size() == 0)
        return;
...
const TextEditor::Palette & TextEditor::GetDefaultPalette()
{
    // a, b, g, r
